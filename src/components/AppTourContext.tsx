...
export const ATLETA_TOUR_STEPS: TourStep[] = [
  // Home (/app)
  { selector: "atleta-greeting", title: "Benvenuto su Livellapp! 🎉", description: "Questa è la tua home. Qui trovi workout, progressi, statistiche settimanali e il tuo PT a portata di tap.", page: "/app" },
  ...
  // Finale
  { selector: "atleta-greeting", title: "Sei pronto! 🎊", description: "Ora conosci tutte le funzionalità di Livellapp. Inizia collegandoti a un PT o esplorando i professionisti disponibili. Buon allenamento! 💪", page: "/app", action: { type: "navigate", target: "/app", delay: 400 } },
];

/* ═══════════════ PT TOUR ═══════════════ */
export const PT_TOUR_STEPS: TourStep[] = [
  // Home (/pt/app)
  { selector: "pt-greeting", title: "Benvenuto su Livellapp! 🎉", description: "Questa è la tua dashboard PT. Qui monitori atleti, schede, messaggi e calendario in un colpo d'occhio.", page: "/pt/app" },
