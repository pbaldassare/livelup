...
const faqCategories = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'LIVELLAPP è una Progressive Web App (PWA). Su iPhone, apri Safari, tocca l\'icona di condivisione e seleziona "Aggiungi a Home". Su Android, il browser ti proporrà automaticamente l\'installazione.'
      },
    ]
  },
  {
