-- =====================================================
-- ATLETA FOLLOWS: "Seguiti" — preferiti salvati dall'atleta
-- (eventi, corsi, gruppi, PT, professionisti) SENZA iscrizione/connessione.
-- Usata dalla hub "Attività" (tab Seguiti) lato PWA atleta.
