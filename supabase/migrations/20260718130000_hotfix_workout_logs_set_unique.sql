-- Hotfix: UNIQUE (workout_exercise_id, set_number) per upsert "Completa serie"
-- Risolve: "there is no unique or exclusion constraint matching the ON CONFLICT specification"
