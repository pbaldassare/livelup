-- =====================================================
-- PT CHAT: gruppi atleti (broadcast/gruppo) + allegati media
-- - Multi-invio PT -> più atleti: riusa `chats`/`messages` esistenti (nessuna migration necessaria)
-- - Gruppi chat PT-atleti: nuove tabelle pt_chat_groups / pt_chat_group_members / pt_chat_group_reads
-- - Messaggi di gruppo: riusano public.messages con nuova colonna chat_group_id
-- - Allegati (immagini/video) in TUTTE le chat: bucket storage `chat-attachments`
-- =====================================================
