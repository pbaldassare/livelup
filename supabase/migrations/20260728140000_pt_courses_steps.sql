-- =====================================================
-- PT Courses — step-based model
-- Evolves pt_courses + adds pt_course_steps /
-- pt_course_step_exercises. Keeps modules/lessons tables
-- (legacy from 20260728130000) and enrollments; progress
-- can track either lesson_id OR step_id.
--
-- Product mapping (API surface uses steps, not modules):
--   modules  ≈ steps   (UI/API: addStep / reorderSteps)
--   lessons  ≈ step exercises (sets/reps/rest via exercises)
-- =====================================================
