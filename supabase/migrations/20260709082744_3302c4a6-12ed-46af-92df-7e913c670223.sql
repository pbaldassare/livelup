DROP POLICY IF EXISTS "group_disciplines_insert_owner" ON public.group_disciplines;
...
BEGIN
  ...
  INSERT INTO public.groups (
    owner_user_id, name, description, image_url,
    location_name, latitude, longitude, visibility, policy_accepted_at
  ) VALUES (
    v_uid,
    trim(_name),
