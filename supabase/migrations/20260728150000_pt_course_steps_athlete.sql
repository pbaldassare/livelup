...
-- Adds pt_course_step_progress (locked / in_progress / completed)
-- for sequential course discovery in the athlete PWA.
-- Keeps legacy pt_course_progress (lessons / optional step_id).
-- =====================================================

-- -----------------------------------------------------
-- 1) pt_course_step_progress
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- 3) Profiles: allow reading authors of published courses
-- -----------------------------------------------------
