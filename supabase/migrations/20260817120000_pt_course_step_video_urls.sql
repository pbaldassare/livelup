-- =====================================================
-- PT Courses — multiple videos per video step
-- Adds video_urls TEXT[] while keeping video_url as the
-- first item for backward compatibility with older clients.
-- =====================================================
...
-- Keep video_url aligned with first array element when array is present
UPDATE public.pt_course_steps
