-- Lovable Cloud SQL prompt: athlete training modality + ceduti visibility + bulk transfer
-- Paste into Lovable SQL / apply via supabase/migrations/20260718190000_pt_athlete_training_modality.sql
