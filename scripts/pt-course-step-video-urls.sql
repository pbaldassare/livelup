-- PT Courses: multi-video per step (video_urls TEXT[])
-- Copiare in Lovable Cloud → SQL Editor e applicare.
-- Allinea video_url al primo elemento per compatibilità legacy.
