-- Lovable Cloud prompt / SQL — apply on push to main or via SQL editor
-- Same as supabase/migrations/20260718160000_pt_availability_bookable_and_google_calendar.sql
